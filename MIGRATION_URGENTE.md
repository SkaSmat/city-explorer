...
**IMPORTANT:** Utilisez le fichier `003_fix_functions_and_schema.sql`

1. Copiez **TOUT** le contenu du fichier:
   ```
   supabase/migrations/003_fix_functions_and_schema.sql
   ```
...
**Note:** Ce fichier DROP les anciennes fonctions (qui avaient des signatures incorrectes) et les recrée avec les bonnes signatures. Vos données GPS/profils ne sont PAS supprimées!
